...
SELECT EMPLOYEE_ID
     , SALARY
     , (TO_CHAR(SYSDATE, 'YYYY') - TO_CHAR(HIRE_DATE, 'YYYY')) * (SALARY * 0.1) AS "상여금"
  FROM EMPLOYEES
;
...
SELECT E.EMPLOYEE_ID
	 , J_NOW.JOB_TITLE AS NOW
     , NVL(J_PAST.JOB_TITLE, '없음') AS PAST
  FROM EMPLOYEES E
 INNER JOIN JOBS J_NOW
    ON J_NOW.JOB_ID = E.JOB_ID 
...
SELECT E.EMPLOYEE_ID  
	 , E.SALARY * POWER(0.85 , COUNT(JH.EMPLOYEE_ID))
  FROM EMPLOYEES E
